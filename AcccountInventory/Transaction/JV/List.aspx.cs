...
namespace AcccountInventory.Transaction.JV
{
    public partial class List : System.Web.UI.Page
    {
        ...
        {
            string query = "SELECT jvp.*,CONCAT(a.AccountCode, '-', p.Code) AS PACode FROM JVParent jvp INNER JOIN "
                            + "Account a  ON jvp.AccountID = a.ID INNER JOIN Project p ON a.ProjectCode = p.ID";
