...
namespace AcccountInventory.Transaction.BR
{
    public partial class List : System.Web.UI.Page
    {
        ...
        {
            string query = "SELECT brp.*,CONCAT(a.AccountCode, '-', p.Code) AS PACode FROM BRParent brp INNER JOIN "
                            + "Account a  ON brp.AccountID = a.ID INNER JOIN Project p ON a.ProjectCode = p.ID";
